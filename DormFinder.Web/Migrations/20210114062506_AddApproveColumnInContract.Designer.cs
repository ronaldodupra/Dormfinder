...
namespace DormFinder.Web.Migrations
{
    ...
    [Migration("20210114062506_AddApproveColumnInContract")]
    partial class AddApproveColumnInContract
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.ChargeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.ContractCharge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.UtilityReading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.UtilityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.Charge", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.ChargeType", "ChargeType")
                        .WithMany()
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.ContractCharge", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.Charge", "Charge")
                        .WithMany()
                        .HasForeignKey("ChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DormFinder.Web.Entities.Contract", null)
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.Utility", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.UtilityType", "UtilityType")
                        .WithMany()
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.UtilityReading", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.Utility", "Utility")
                        .WithMany()
