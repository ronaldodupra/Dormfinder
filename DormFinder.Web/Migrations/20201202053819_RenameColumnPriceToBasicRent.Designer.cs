...
namespace DormFinder.Web.Migrations
{
    ...
    [Migration("20201202053819_RenameColumnPriceToBasicRent")]
    partial class RenameColumnPriceToBasicRent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.RoomOccupant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("BedspaceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BedspaceId");

                    b.HasIndex("TenantId");

                    b.ToTable("roomoccupant");
                });
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.RoomOccupant", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.Bedspace", null)
                        .WithMany("RoomOccupant")
                        .HasForeignKey("BedspaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DormFinder.Web.Entities.Tenant", "Tenant")
                        .WithMany()
