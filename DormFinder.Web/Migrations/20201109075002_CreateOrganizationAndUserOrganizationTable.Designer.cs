...
namespace DormFinder.Web.Migrations
{
    ...
    [Migration("20201109075002_CreateOrganizationAndUserOrganizationTable")]
    partial class CreateOrganizationAndUserOrganizationTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.BuildingAmenities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.Amenity", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.BuildingAmenities", "BuildingAmenities")
                        .WithMany()
                        .HasForeignKey("Id")
            ...
            modelBuilder.Entity("DormFinder.Web.Entities.Inclusion", b =>
                {
                    b.HasOne("DormFinder.Web.Entities.RoomInclusion", "RoomInclusions")
                        .WithMany()
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
